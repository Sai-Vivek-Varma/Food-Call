        ...
        <div className="container-custom">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center justify-between mb-12 space-y-6 lg:space-y-0">
            <div className="space-y-4">
              ...
              <p className="text-gray-600 text-lg lg:text-xl max-w-2xl">
                Track your food donation impact and see the difference you're making in the community.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100">
              <h3 className="text-xl font-bold mb-6 gradient-text">Quick Stats</h3>
              <div className="space-y-6">
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
                  <span className="font-medium text-gray-700">Average Response Time</span>
                  <span className="text-2xl font-bold text-green-600">2.3 hrs</span>
                </div>
                ...
                <div className="flex items-center justify-between p-4 bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl">
                  <span className="font-medium text-gray-700">Active Donors</span>
