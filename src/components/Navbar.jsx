          ...
          <div className="container mx-auto px-4 py-3 space-y-1">
            ...
            {user ? (
              <>
                <Link
                  to="/dashboard"
                  className="block px-4 py-2 rounded-md text-foreground hover:text-sage-700 hover:bg-sage-50/80 transition-colors"
                >
                  Dashboard
                </Link>
                <button
              ...
              <Link 
                to="/auth" 
                className="block px-4 py-2 bg-sage-500 text-white rounded-md hover:bg-sage-600 transition-colors"
              >
                Sign In
              </Link>
            )}
