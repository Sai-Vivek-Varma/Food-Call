...
const HowItWorks = () => {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl font-bold mb-6 text-gray-900">List Your Surplus Food</h2>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700">Quick and easy listing process</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-sage-500" />
                  <span className="text-gray-700">Upload photos to showcase your donation</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-sage-500" />
                  <span className="text-gray-700">Set flexible pickup times</span>
                </div>
              </div>
            </div>
              ...
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -left-4 bg-white p-4 rounded-lg shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-sm">Easy Listing</div>
                      <div className="text-xs text-gray-500">3 minutes setup</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div>
              ...
              <h2 className="text-3xl font-bold mb-6 text-gray-900">Browse & Reserve Donations</h2>
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-blue-500" />
                  <span className="text-gray-700">Filter by location and food type</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-blue-500" />
                  <span className="text-gray-700">Instant reservation confirmation</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1">
              ...
              <h2 className="text-3xl font-bold mb-6 text-gray-900">Coordinate & Complete</h2>
              <p className="text-gray-600 text-lg mb-6 leading-relaxed">
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700">Seamless coordination tools</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-purple-500" />
                  <span className="text-gray-700">Track your impact and contributions</span>
                </div>
                <div className="flex items-center gap-3">
                  <CheckCircle className="w-5 h-5 text-purple-500" />
                  <span className="text-gray-700">Community feedback and ratings</span>
                </div>
              </div>
            </div>
            <div className="order-1 lg:order-2">
              <div className="relative">
                ...
                <div className="absolute -bottom-4 -left-4 bg-white p-4 rounded-lg shadow-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-sm">Real Impact</div>
                      <div className="text-xs text-gray-500">Lives changed daily</div>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4 text-gray-900">Why Choose FoodCall?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm text-center">
              ...
              <h3 className="text-lg font-semibold mb-3 text-gray-900">Safety First</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm text-center">
              ...
              <h3 className="text-lg font-semibold mb-3 text-gray-900">Real-Time Updates</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm text-center">
              ...
              <h3 className="text-lg font-semibold mb-3 text-gray-900">Measurable Impact</h3>
              <p className="text-gray-600 text-sm leading-relaxed">
      ...
      <section className="py-16 px-6">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-3xl font-bold mb-6 text-gray-900">Ready to Start Making a Difference?</h2>
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
