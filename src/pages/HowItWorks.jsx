        ...
        <div className='container mx-auto max-w-6xl px-4'>
          <section className='mb-12'>
            ...
            <p className='text-center text-lg text-muted-foreground max-w-3xl mx-auto mb-12'>
              Our platform connects food donors with orphanages to reduce food
              waste and help those in need. The process is simple, transparent,
              and effective.
            </p>
          </section>
          ...
          <div className='grid md:grid-cols-3 gap-8 mb-16'>
            <div className='bg-white p-6 rounded-xl shadow-sm border border-border animate-fade-up'>
              ...
              <p className='text-muted-foreground text-center'>
                Create an account as a food donor. This allows you to post food
                donations that would otherwise go to waste.
              </p>
            </div>

            <div
              className='bg-white p-6 rounded-xl shadow-sm border border-border animate-fade-up'
            ...
            >
              ...
              <p className='text-muted-foreground text-center'>
                List the surplus food with details like quantity, expiry date,
                and pickup information for orphanages to view.
              </p>
            </div>
            ...
            >
              ...
              <p className='text-muted-foreground text-center'>
                Registered orphanages browse available donations and reserve
                food based on their needs.
              </p>
            </div>
          </div>
          ...
          <div className='grid md:grid-cols-2 gap-12 mb-16'>
            <div className='bg-white p-8 rounded-xl shadow-sm border border-border animate-fade-up'>
              ...
              <ul className='space-y-3'>
                <li className='flex items-start'>
                  <span className='bg-sage-100 text-sage-600 rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-1'>
                    ✓
                  </span>
                ...
                <li className='flex items-start'>
                  ...
                  <p>
                    Post available food donations with all necessary details
                  </p>
                </li>
                <li className='flex items-start'>
                  <span className='bg-sage-100 text-sage-600 rounded-full w-6 h-6 flex items-center justify-center mr-3 mt-1'>
            ...
            <div
              className='bg-white p-8 rounded-xl shadow-sm border border-border animate-fade-up'
              style={{ animationDelay: "0.2s" }}
            >
